...
Dieser Anhang dokumentiert die schrittweise Berechnung des Bootstrap-Kondensators $C_{\mathrm{BOOT}}$ für die HS-Ansteuerung des MOSFETs IPP034N08N5 über den Treiber IR2104. Alle Werte basieren auf den Datenblättern der Bauteile sowie der ON Semiconductor Applikationsschrift AN-6076 \cite{AN6076}.
...
Der typische Ladungsverbrauch des IR2104-Level-Shifters während einer einzelnen HS-Einschaltphase beträgt:
\begin{equation}
