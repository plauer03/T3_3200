...
Es wird die Synchrongleichrichtung (IR2104) bei einer Sperrschichttemperatur von $T_{\mathrm{J,design}} = 100^\circ\mathrm{C}$ ($R_{\mathrm{DS(on)}} = 0{,}0048\,\Omega$) abgebildet. 
